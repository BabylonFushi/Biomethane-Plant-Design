...
│   ├── 04_clasificacion_suelo.ipynb
│   ├── 05_red_natura2000.ipynb
│   └── 06_ganado_porcino.ipynb
...
data/
├── raw/        Salidas de los notebooks de descarga
└── processed/  Grid procesado, Top 10, capas intermedias
```

## Pendiente de limpieza

- [ ] `01_red_viaria`: eliminar celda con output de error (kernel crash)
...
- [ ] `04_clasificacion_suelo`: sustituir rutas absolutas
- [ ] `05_red_natura2000`: sustituir rutas absolutas
- [ ] `06_ganado_porcino`: sustituir rutas absolutas
