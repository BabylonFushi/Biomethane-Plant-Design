...
├── map/                        HTML/PNG maps generated by each notebook, same subfolder structure as raw/
│   ├── 01_ganado_porcino/
│   ├── 02_gasoductos/
│   ├── 03_pendiente_dem/
│   ├── 04_red_natura2000/
...
│   └── 02_analysis/            Final suitability map
...
├── map/                      Mapas HTML/PNG generados por cada notebook, misma estructura de subcarpetas que raw/
│   ├── 01_ganado_porcino/
│   ├── 02_gasoductos/
│   ├── 03_pendiente_dem/
│   ├── 04_red_natura2000/
│   ├── 05_red_viaria/
│   ├── 06_clasificacion_suelo/
│   └── 02_analysis/          Mapa de idoneidad final
